...
// let neighborhoods = JSON.parse(fs.readFileSync('/home/ec2-user/environment/data/neighborhoods.json'));
// let groupAddresses = JSON.parse(fs.readFileSync('/home/ec2-user/environment/data/aa_cleaned/groupAddresses.json'));
let final = JSON.parse(fs.readFileSync('/home/ec2-user/environment/data/aa-final.json'));
...
async.eachSeries(final, function(value, callback) {
    ...
    client.connect();
     var thisQuery = `INSERT INTO aafinal VALUES (E'${value.groupname}',${value.gid},E'${value.zonename}',E'${value.neighborhood}', E'${value.day}',E'${value.starttime}', E'${value.sampm}', E'${value.endtime}', E'${value.eampm}',E'${value.type}', E'${value.interest}',E'${value.address}', E'${value.crossstreet}',${value.long}, ${value.lat},E'${value.wheelchair}');`;
    ...
    //   var thisQuery = `INSERT INTO neighborhoods VALUES (E'${value.zonename}', E'${value.neighborhood}');`;
