...
### Assignment Details
###
Populate dummy data tables with ALL the data from the first three rows of the AA zone (01) and save to an [Excel file]("./dummy_data.xlsx"). Draw and upload a [database schema diagram]("./sql_diagram.png"). 
##
### Process
###
**Decisions**: 
